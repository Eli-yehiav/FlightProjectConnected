...
def addusers(r):
    try:
        ...
        return JsonResponse({'message':'Error!\n User Is Already In The System!'},safe=False)
    except:
        pass    
...
def customers(request,id=-1):
    if request.method == 'POST': 
        ...
        except:Customers.objects.create(first_name=first_name,last_name=last_name,phone=phone,credit_num=credit_num,user=user)
